                ...
                if(row_configOnoffCommandAdmin.Editconfig === 'true') {
                    ...
                    for (const row_configChannel of client.getConfigChannel./*iterate*/all()) {
                        for (const row_configOnoffRole of client.getConfigRole./*iterate*/all()) {
                            ...
                            //         console.log(chalk.cyan('[' + DateTime.utc().toFormat(format1) + ']' + lang.prefix.clan, chalk.white(lang.admin.shutdown.log)));
                            ...
                            //         });
                                    ...
                                    console.log(chalk.cyan('[' + DateTime.utc().toFormat(format1) + ']' + lang.prefix.clan, chalk.white(lang.admin.shutdown.errorperms)));
                                }
                            } else {
                                console.log(chalk.cyan('[' + DateTime.utc().toFormat(format1) + ']' + lang.prefix.clan, chalk.white(lang.admin.shutdown.errorchannel)));
                            }
                        }
                    }
                }
